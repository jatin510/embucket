...
final AS (
  ...
  SELECT 
    ...
    prep_crm_opportunity.crm_business_dev_rep_id_lookup,
    ...
    prep_crm_opportunity.close_fiscal_quarter_name,
    ...
    CASE 
      WHEN prep_crm_opportunity.arr_created_date >= prep_date.current_first_day_of_fiscal_quarter
