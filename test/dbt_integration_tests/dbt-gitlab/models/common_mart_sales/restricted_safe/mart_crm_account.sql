...
final AS (
  ...
  SELECT
    ...
    dim_crm_account.crm_business_dev_rep_id,
    ...
    dim_crm_account.crm_sales_dev_rep_id,
    ...
    dim_crm_account.pubsec_type,
    dim_crm_account.gs_csm_compensation_pool,
    dim_crm_account.groove_notes,
    dim_crm_account.groove_engagement_status,
    dim_crm_account.groove_inferred_status,
    dim_crm_account.compensation_target_account,
    ...
    dim_crm_account.ptp_score,
    dim_crm_account.ptp_score_value,
    dim_crm_account.ptp_insights,
  ...
  LEFT JOIN dim_crm_user AS crm_account_owner
    ON fct_crm_account.crm_account_owner_id = crm_account_owner.dim_crm_user_id
  LEFT JOIN dim_crm_user AS sales_development_team
    ON dim_crm_account.crm_sales_dev_rep_id = sales_development_team.dim_crm_user_id
