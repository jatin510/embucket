...
renamed AS (
  ...
  SELECT
    ...
    true::BOOLEAN                                                  AS is_headquarters,
    ...
    true::BOOLEAN                                       AS has_company_verified_address,
    zi_c_employees::NUMBER                                               AS employees,
    zi_c_estimated_age::NUMBER                                           AS estimated_age,
    true::BOOLEAN                                                 AS is_b2b,
    true::BOOLEAN                                                 AS is_b2c,
    ...
    true::BOOLEAN                                      AS is_small_business,
    true::BOOLEAN                                              AS is_public,
    true::BOOLEAN                                         AS has_mobile_app,
    ...
    true::BOOLEAN                                         AS is_fortune_100,
    true::BOOLEAN                                         AS is_fortune_500,
    true::BOOLEAN                                         AS is_s_and_p_500,
    true::BOOLEAN                                         AS is_domestic_hq,
    true::BOOLEAN                                     AS is_ultimate_parent,
    true::BOOLEAN                                          AS is_subsidiary,
    true::BOOLEAN                                          AS is_franchisor,
    true::BOOLEAN                                          AS is_franchisee,
    true::BOOLEAN                                    AS is_immediate_parent,
    true::BOOLEAN                                     AS is_domestic_parent,
    ...
    TO_DATE('202502, 'YYYYMM')::DATE                           AS release_date
  FROM source
